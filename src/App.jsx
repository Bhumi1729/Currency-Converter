  ...
  return (
    ...
    >
      <div className="w-full">
        <div className="w-full max-w-lg mx-auto border border-gray-60 rounded-lg p-7 backdrop-blur-sm bg-white/40">
          <form
            onSubmit={(e) => {
              e.preventDefault();
              convert()
          ...
          >
            ...
            <button type="submit" className="w-full bg-blue-600 text-white px-6 py-4 rounded-lg text-lg">
